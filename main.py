...
def on_hit_wall(sprite, location):
    if tiles.tile_at_location_equals(location, myTiles.tile1):
...
Engineer = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
Engineer.set_position(80, 108)
controller.move_sprite(Engineer, 160, 0)
Engineer.set_flag(SpriteFlag.STAY_IN_SCREEN, True)
mySprite2 = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
anim = animation.create_animation(ActionKind.flying, 100)
animation.attach_animation(mySprite2, anim)
...
anim.add_animation_frame(img("""
    ........................
        ...
        ........................
"""))
animation.set_action(mySprite2, ActionKind.flying)
...
def on_update_interval():
    ...
    Falling.set_position(randint(20, 140), 0)
    limit = min(10, info.score())
    Falling.set_velocity(1, 11)
    Falling.ay = 3
